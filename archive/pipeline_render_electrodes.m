...
% 
% Original code from Dora Hermes: 
%   - https://github.com/MultimodalNeuroimagingLab/HAPwave/blob/main/pcc_fig7a_dMRI_renderLimbic_diadem.m
% 
% CODE DEPENDENCIES: 
...
% 
% BIDS DATASET: 
%   - https://nemar.org/dataexplorer/detail?dataset_id=ds004696
%   - https://osf.io/6mp39/files/osfstorage
% 
% Cedric Cannard, June 2025

clear; clc; close all

% main path to local code repos
mainDir = '/Users/cedriccannard/Documents/MATLAB';

% Path to BIDS tutorial dataset
data_path = '/Users/cedriccannard/Downloads/ds004696_osf';

% % add path to dependencies
% code_path = fullfile(mainDir, 'HAPwave');
% addpath(genpath(code_path))
% cd(code_path)
code_path2 = fullfile(mainDir, 'vistasoft');
addpath(genpath(code_path2))
code_path3 = fullfile(mainDir, 'AFQ');
addpath(genpath(code_path3))
code_path4 = fullfile(mainDir, 'along-tract-stats');
addpath(genpath(code_path4))
...
% update mainDir
mainDir = fullfile(mainDir, "iEEGLAB");
cd(mainDir)
